...
// IMVCommon
#define COCOAPODS_POD_AVAILABLE_IMVCommon
#define COCOAPODS_VERSION_MAJOR_IMVCommon 0
#define COCOAPODS_VERSION_MINOR_IMVCommon 0
#define COCOAPODS_VERSION_PATCH_IMVCommon 1

// IMVTheme
#define COCOAPODS_POD_AVAILABLE_IMVTheme
#define COCOAPODS_VERSION_MAJOR_IMVTheme 0
#define COCOAPODS_VERSION_MINOR_IMVTheme 0
#define COCOAPODS_VERSION_PATCH_IMVTheme 1
